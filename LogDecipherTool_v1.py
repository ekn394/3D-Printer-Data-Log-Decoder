...
def determinePrintJobTime():
    ...
    #    print "This print job was called '" + printJobTitle + "' and took " + str(difference//3600)+":"+ str((difference%3600)//60)+":" + str((difference%3600)%60) + " to complete."
    #else:
    #    print "This print job was called '" + printJobTitle + "' and took " + str(difference//60)+":"+str(difference%60) + " to complete."
...
#openLogFile("Log310F_171024.txt")

#decodeNextPrintJob()

#decodeAllLines("Log310F_171024.txt")

#dailySummaryReport()
#decodeAllLines("Log310F_171025.txt")
